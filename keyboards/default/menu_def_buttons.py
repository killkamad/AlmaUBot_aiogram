...
def always_stay_menu_keyboard():
    ...
    acalendar_button = KeyboardButton(text="🗒 Академический календарь", callback_data="/academ_calendar")
    ...
    markup.add(schedule_button, faq_button, library_button, shop_button, acalendar_button, certificate_button,
