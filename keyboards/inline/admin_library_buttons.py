...
def inline_keyboard_library_second_page_admin():
    ...
    callback_edit_resources_button = InlineKeyboardButton(text="⚡ Изменить электронные ресурсы", callback_data='edit_lib_resource')
...
def inline_keyboard_library_res_admin():
    markup = InlineKeyboardMarkup(row_width=1)
    callback_button1 = InlineKeyboardButton(text="📕 Лицензионные Базы Данных", callback_data='edit_library_registration')
...
def inline_keyboard_library_del_res_admin():
    markup = InlineKeyboardMarkup(row_width=1)
    callback_button1 = InlineKeyboardButton(text="📕 Лицензионные Базы Данных", callback_data='del_library_registration')
    callback_button2 = InlineKeyboardButton(text="📗 Базы данных свободного доступа(Казахстанские)",
